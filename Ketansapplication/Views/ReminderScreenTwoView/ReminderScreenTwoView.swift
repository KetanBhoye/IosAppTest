...
struct ReminderScreenTwoView: View {
    @StateObject var reminderScreenTwoViewModel = ReminderScreenTwoViewModel()
    ...
    var body: some View {
        VStack {
            VStack {
                VStack(alignment: .leading, spacing: 0) {
                    HStack {
                        HStack {
                            ...
                            .frame(width: getRelativeWidth(89.0), height: getRelativeHeight(21.0),
                                   alignment: .top)
                            Spacer()
                    ...
                    VStack {
                        ZStack(alignment: .bottomLeading) {
                            VStack(alignment: .leading, spacing: 0) {
                                ScrollView(.horizontal, showsIndicators: false) {
                                    VStack(alignment: .leading, spacing: 0) {
                                        ...
                                        HStack {
                                            ...
                                            VStack(alignment: .leading, spacing: 0) {
                                                Image("img_rectangle122_120x120")
                                                    .resizable()
                                                    .frame(width: getRelativeWidth(120.0),
                                                           height: getRelativeWidth(120.0),
                                                           alignment: .center)
                                ...
                                HStack {
                                    TextField(StringConstants.kLblMeetDetails,
                                              text: $reminderScreenTwoViewModel.meetingremText)
                                        .font(FontScheme
                                ...
                                HStack {
                                    TextField(StringConstants.kLblMeetLink,
                                              text: $reminderScreenTwoViewModel.calendardateText)
                                        .font(FontScheme
                                            .kPoppinsMedium(size: getRelativeHeight(20.0)))
                                        .foregroundColor(ColorConstants.Black900)
                                        .padding()
                                ...
                                .frame(width: getRelativeWidth(342.0),
                                       height: getRelativeHeight(253.0), alignment: .leading)
                                .overlay(RoundedCorners(topLeft: 16.0, topRight: 16.0,
                                                        bottomLeft: 16.0, bottomRight: 16.0)
                                        .stroke(ColorConstants.Black900,
                                                lineWidth: 1))
                            ...
                            .frame(width: getRelativeWidth(342.0), height: getRelativeHeight(708.0),
                                   alignment: .center)
                            ...
                            .cornerRadius(0.0)
                            .padding(.top, getRelativeHeight(652.0))
                        }
                        .hideNavigationBar()
                        .frame(width: getRelativeWidth(375.0), height: getRelativeHeight(742.0),
                               alignment: .leading)
                ...
                .frame(width: getRelativeWidth(375.0), height: getRelativeHeight(793.0),
                       alignment: .leading)
                VStack {
                    Text("tabbar")
                        .minimumScaleFactor(0.5)
...
struct ReminderScreenTwoView_Previews: PreviewProvider {
    static var previews: some View {
        ReminderScreenTwoView()
    }
}
